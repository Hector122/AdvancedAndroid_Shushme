...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TOD Modify the Adapter to take a PlaceBuffer in the constructor
    ...
    // TOD Implement a method called refreshPlacesData that:
    ...
    public void refreshPlacesData() {
        ...
        PendingResult<PlaceBuffer> placeBufferPendingResult = Places.GeoDataApi.getPlaceById(
                mClient, guids.toArray(new String[0]));
    ...
    //TOD Set the getPlaceById callBack so that onResult calls the Adapter's swapPlaces with the result

...
public class PlaceListAdapter extends RecyclerView.Adapter<PlaceListAdapter.PlaceViewHolder> {
    ...
    public PlaceListAdapter(Context context, PlaceBuffer places) {
        // TOD Take a PlaceBuffer as an input and store it as a local private member mPlaces
        this.mContext = context;
        this.mPlaceBuffer = places;
    }
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        // TOD Implement onBindViewHolder to set the view holder's Name and Address text fields
    ...
    //TOD Implement a public method swapPlaces that replaces the current mPlaces PlaceBuffer with a new one
    ...
    public int getItemCount() {
        // TOD Update getItemCount to return mPlaces's item count
